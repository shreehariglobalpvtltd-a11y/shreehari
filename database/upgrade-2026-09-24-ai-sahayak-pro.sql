...
('ai_web_agent_on',   '0',  'bool',  'ai','WEBSITE + APP assistant with tools (reads the register, reports, graphs, role by sign-in). OFF = the plain question-answer relay of before',0),
