...
var PRECACHE = [
  /* 25 Sep 2026: the built bundle. Committed, so these always exist;
     precaching them costs one entry each and makes a repeat open of a
     bundled install need no network at all. The separate files below
     stay in the list because index.php falls back to them whenever the
     switch is off or the bundle is out of date. */
