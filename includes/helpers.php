...
function shg_customer_payload(array $detail): array
{
    ...
    return [
        ...
        // The advance-booking offer as its own figure (26 Sep 2026 follow-up),
        // so My Bookings can name what early booking saved on this ticket.
        'advanceDiscount' => (float) ($detail['advance_discount'] ?? 0),
