...
(function () {
  ...
  var SHGInstall = (function () {
    ...
    function head() {
      return '<div class="pwa-head"><img src="/assets/img/icon-192.png?v=20260924f" alt="" width="52" height="52">'
...
(function ContactDial() {
  ...
  /* Integration 24 Sep 2026: one contact button, never two. The dial is
     OFF until Admin -> Settings contact_dial_on; ON, it replaces the
     WhatsApp FAB (the dial carries WhatsApp too) in the same spot. */
  var on = (boot.settings || {}).contact_dial_on;
  if (!(on === true || on === 1 || on === '1')) return;
  fab.hidden = false;
  var waFab = document.getElementById('waFab'); if (waFab) waFab.hidden = true;
