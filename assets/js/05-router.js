...
function initQuickTicket() {
  ...
  function renderPlan(msg) {
    ...
    var html = askHtml + sameHtml
      ...
      + (p.from && p.to ? '<div class="qt-route" aria-hidden="true"><span>' + esc(p.boardingCode || p.from) + '</span><i><b><img src="/assets/img/bus-side.svg?v=20260926l" alt="" width="640" height="200" decoding="async"></b></i><span>' + esc(p.to) + '</span></div>' : '')
