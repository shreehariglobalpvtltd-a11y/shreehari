...
/* 23 Sep 2026 (v3 brief §7): a customer's number must look like a real
   mobile for the country picked - India +91 starts 6-9, Nepal +977 starts 9
   (96/97/98 today) - not merely be ten digits. Staff counters keep their
   looser rule (walk-ins, international numbers). */
...
function renderStatus(id) {
  ...
  <div class="status-card tk2${conf ? ' confirm-success' : ''}" id="ticketCard">
    <div class="tk2-head">
      <div class="tk2-brand">
        <img src="/assets/img/logo.png?v=20260923c" alt="" loading="lazy" decoding="async">
