...
function renderStatus(id) {
  ...
  <div class="status-card tk2${conf ? ' confirm-success' : ''}" id="ticketCard" data-pnr="${esc(b.id)}">
    <div class="tk2-head premium-ticket-head">
      <div class="tk2-brand">
        <img src="/assets/img/logo.png?v=20260926d" alt="" loading="lazy" decoding="async">
      ...
      <img class="premium-ticket-bus" src="/assets/img/bus-shg-sm.webp?v=20260926d" width="600" height="312" alt="" decoding="async">
    </div>
